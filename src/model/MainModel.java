...
>>>>>>> 7335317999b66617b53caf2e07915a8d918b402e
	...
	public int[] validateLogin(String username, String password) throws SQLException{
		...
		return database.verifyMember(username, password );
	}
	...
	public void updateProject(Project originalProject, Project updatedProject) throws Exception {
		...
		// check If updated project suits original activities total budget
		if( ! actsTotalBudgetSuitsParent(updatedProject, originalProject)){
			throw new Exception("Updated project Budget doesn't suit original Project Activites' budgets");
		}
		...
		for(Activity act: projectActivities){
			...
			if( activityDatesSuitsParent(act, updatedProject) != 0){
...
/*		if (updatedActivity.getStartDate().compareTo(updatedActivity.getFinishDate()) > 0){
